# nutrition-patterns Specification

## Purpose
Define the eating pattern configuration system that allows users to select meal timing strategies (Standard 12-hour, 16:8 Intermittent Fasting, OMAD) independently from diet type. This specification ensures accurate PRIME calculations by passing eating window hours to backend prediction APIs.
## Requirements
