            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="space-y-2 rounded-lg border bg-card p-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-primary">{macros.protein.percentage}%</span>
                </div>
                <div className="text-xl font-bold">{macros.protein.grams}g</div>
                <div className="text-xs text-muted-foreground">{macros.protein.calories} calories</div>
              ...
              <div className="space-y-2 rounded-lg border bg-card p-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-primary">{macros.carbs.percentage}%</span>
                </div>
                <div className="text-xl font-bold">{macros.carbs.grams}g</div>
                <div className="text-xs text-muted-foreground">{macros.carbs.calories} calories</div>
              ...
              <div className="space-y-2 rounded-lg border bg-card p-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-primary">{macros.fat.percentage}%</span>
                </div>
                <div className="text-xl font-bold">{macros.fat.grams}g</div>
                <div className="text-xs text-muted-foreground">{macros.fat.calories} calories</div>
